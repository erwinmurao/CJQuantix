...
const RegistrationPage = () => {
  ...
  return (
    <div className="flex min-h-screen  items-center justify-center p-4">
      <div className="w-full max-w-[900px] h-full max-h-full flex flex-col lg:border-2 lg:p-8 lg:rounded-2xl lg:flex-row items-center bg-white lg:bg-transparent border-2  rounded-2xl shadow-2xl lg:shadow-2xl overflow-hidden lg:gap-12">

        {/* Left Side: Branding */}
        <div className="w-full lg:w-1/2 p-8 lg:p-0 space-y-6">
          <div className="hidden lg:block w-full p-8 bg-white/50 backdrop-blur-sm">
            <img
          ...
          <form onSubmit={handleRegistration} className="w-full">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {confirmPassword && (
                  <p
                    className={`text-xs mt-1 font-medium ${password === confirmPassword ? "text-green-600" : "text-red-600"}`}
                  >
              ...
              <button
                type="submit"
                className="w-full bg-purple-600 text-white py-3 rounded-xl hover:bg-purple-700 transition-all font-bold shadow-lg shadow-purple-200 mt-4"
              >
                Create Account
              </button>
